    ...
    default:
     ...
     return(
       <div className='relative h-[90vh]'>
        ...
        {player && (
          <div className=' -ml-[12rem] mr-4 -mt-[15rem] space-y-8'>
      <div className='text-[35px] font-bold text-yellow-600 mx-3 mb-6 px-3'> PlayerName : {player.name} <br /> is playing the Game now ...</div>
       ...
       <div className=' relative w-[544px]  h-[544px] bg-transparent bg-yellow-500 border-[10px] border-dashed border-yellow-700 border-spacing-96 shadow-2xl shadow-black'>
          {!gameOver && (
            snake.map(([x,y],index)=>( 
